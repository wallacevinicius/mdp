...
// dir random
//$dir_random = md5(date('Y-m-d H:i:s.') . gettimeofday()['usec']) ;

mkdir( 'uploads/' . $DIR_RANDOM , 0700 );

// Pasta onde o arquivo vai ser salvo
$_UP['pasta'] = 'uploads/' . $dir_random . '/';
...
if ($_FILES['arquivo']['error'] != 0 && $_FILES['arquivo1']['error'] != 0) {
